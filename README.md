 ...
 * Heroku Users :
   ...
   * Deploy.
 * Railway Users :
   * Click on [Deploy Now](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2Fvital987%2Fvubuntu&envs=VNC_PASS%2CVNC_TITLE%2CVNC_RESOLUTION&optionalEnvs=VNC_TITLE%2CVNC_RESOLUTION&VNC_PASSDesc=VNC+Password&VNC_TITLEDesc=VNC+Title&VNC_RESOLUTIONDesc=VNC_RESOLUTION&VNC_PASSDefault=samplepass) button.
   * Set app name & variables.
   * Deploy.
 * Non-Heroku Useers :
   * Edit & Run Command :
